...
const options = {
	definition: {
		...
		info: {
			...
			version: "1.0.0",
			description: `\nTo solve the prevalent problems in Supply Chain Management - Product Traceability, Dispute Resolution, Decentralized Authority, Costs of Middlemen and Trustless Transactions, the project extensibly uses Solidity Smart Contracts Technology of Ethereum Blockchain.\n\n
